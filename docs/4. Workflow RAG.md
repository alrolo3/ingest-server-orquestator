...
Workflow name: `RAG query retrieval tool v4 conversation aware`
...
|---|---:|---|
| `consts.indexName` | `open-rag-embeddings-v4` | Elasticsearch index used for retrieval. |
...
| Index resolved as | `/open-rag-embeddings-v4/_search` |
...
|---|---|---|
| 1 | `standalone_question` | Multilingual lexical search across `content_lex.*`, title, and file name. |
| 2 | `question_original` | Lexical search using the exact user wording. |
| 3 | `query_en` | English-focused lexical search over `content_lex.en`, title, and file name. |
| 4 | `query_es` | Spanish-focused lexical search over `content_lex.es`, title, and file name. |
| 5 | `standalone_question` | Semantic search over `content_dense`, while `_source.content` stores the returned chunk text. |
| 6 | `standalone_question` | Sparse semantic search over `content_sparse`. |
| 7-10 | `standalone_question`, `question_original`, `query_en`, `query_es` | Sparse semantic search over `clean_title`; repeated branches increase title influence in RRF. |
| 11-14 | `standalone_question`, `question_original`, `query_en`, `query_es` | Sparse semantic search over `headings`; repeated branches increase section/header influence in RRF. |
