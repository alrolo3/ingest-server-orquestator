...
| 6-9 | `standalone_question`, `question_original`, `query_en`, `query_es` | Title-focused semantic search over `title_semantic`; repeated branches intentionally increase title influence in RRF. |
