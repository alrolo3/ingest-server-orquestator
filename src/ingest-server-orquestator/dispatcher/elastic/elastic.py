...
TITLE_SPARSE_INFERENCE_ID = "opensearch-multilingual-neural-sparse"
TITLE_SPARSE_TASK_TYPE = "sparse_embedding"
...
TITLE_SPARSE_FIELD = {
    "type": "semantic_text",
    "inference_id": TITLE_SPARSE_INFERENCE_ID,
    "chunking_settings": {
        "strategy": "none",
    },
}
...
OPEN_RAG_MAPPINGS = {
    ...
    "_meta": {
        "description": (
            ...
            "title_sparse is a disabled-chunking sparse semantic_text title "
            "field for validation."
        ),
        "language_detection_model": LANGUAGE_DETECTION_MODEL,
        "expected_model_settings": MODEL_SETTINGS,
        "title_sparse_inference": {
            "inference_id": TITLE_SPARSE_INFERENCE_ID,
            "task_type": TITLE_SPARSE_TASK_TYPE,
        },
        "chunking": (
    ...
    "properties": {
        ...
        "title_sparse": TITLE_SPARSE_FIELD,
        "source_file_name": {
            "type": "keyword",
            "fields": {
                "text": {"type": "text"},
        ...
        },
        {
            "script": {
                ...
                "source": (
                    ...
                    "} "
                    "if (ctx.title_sparse != null) { "
                    "ctx.title_sparse = ctx.title_sparse.replace('${', '$ {'); "
                    "}"
                ),
            }
        },
        {
            "script": {
                ...
                "source": (
                    ...
                    "String sparseTitle = cleanTitle(ctx.title_sparse); "
                    ...
                    "if (sparseTitle == null) { sparseTitle = semanticTitle; } "
                    "if (sparseTitle == null) { sparseTitle = cleanedTitle; } "
                    "if (sparseTitle != null) { ctx.title_sparse = sparseTitle; } "
...
def build_open_rag_mappings(inference_id: str) -> dict[str, Any]:
    ...
    mappings["properties"]["title_sparse"] = deepcopy(TITLE_SPARSE_FIELD)
...
class ElasticsearchDispatch(AbstractDispatcher):
    ...
    def _ensure_index_mappings(self) -> None:
        ...
        missing_properties = {
            ...
            for field_name in ("title_semantic", "title_sparse")
