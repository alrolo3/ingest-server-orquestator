...
OPEN_RAG_MAPPINGS = {
    ...
    "_meta": {
        "description": (
            ...
            "chunk text is stored in content. Dense content_dense and sparse "
            "content_sparse fields are generated by the ingest pipeline, "
            "searchable, and excluded from _source. Cleaned titles and "
            "Docling headings stay in _source and are indexed as sparse "
            "semantic_text."
        ),
...
OPEN_RAG_PIPELINE = {
    "description": (
        "Escape inference-template placeholders and normalize DocumentChunk metadata."
    ),
    "processors": [
        {
            "set": {
